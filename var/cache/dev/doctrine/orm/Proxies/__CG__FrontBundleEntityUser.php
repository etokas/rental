...
class User extends \FrontBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'reservations', 'lastname', 'firstname'];
        }
     ...
     * {@inheritDoc}
     */
    public function addReservation(\FrontBundle\Entity\Reservation $reservation)
    {
     ...
     * {@inheritDoc}
     */
    public function removeReservation(\FrontBundle\Entity\Reservation $reservation)
    {
