...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \FrontBundle\Form\UserType A FrontBundle\Form\UserType instance.
     */
    protected function getApp_Form_RegistrationService()
    {
        return $this->services['app.form.registration'] = new \FrontBundle\Form\UserType();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'appventus', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'unix_socket' => '/Applications/MAMP/tmp/mysql/mysql.sock', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/FrontBundle/Entity'))), 'FrontBundle\\Entity');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_bf82b07420a8a22348642de4311a5ac1f20468f051fc5ce8f524b537a9994ddd');
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'FrontBundle\\Form\\UserType', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'FrontBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('bfe696df020db116dda1a97b95b6b1f98cc47626');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'bfe696df020db116dda1a97b95b6b1f98cc47626',
            'locale' => 'fr',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'bfe696df020db116dda1a97b95b6b1f98cc47626',
            ...
            'fos_user.registration.form.type' => 'FrontBundle\\Form\\UserType',
